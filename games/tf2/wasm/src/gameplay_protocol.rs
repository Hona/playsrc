...
pub fn decode(bytes: &[u8]) -> Option<AdvanceInput> {
    ...
    let select_weapon = match (select >> 8) & 0xff {
        ...
        7 => Some(playsrc_tf2::Weapon::Shotgun),
        8 => Some(playsrc_tf2::Weapon::Shovel),
        9 => Some(playsrc_tf2::Weapon::Minigun),
        10 => Some(playsrc_tf2::Weapon::HeavyShotgun),
        11 => Some(playsrc_tf2::Weapon::Fists),
        12 => Some(playsrc_tf2::Weapon::SniperRifle),
        13 => Some(playsrc_tf2::Weapon::Smg),
        14 => Some(playsrc_tf2::Weapon::Kukri),
        17 => Some(playsrc_tf2::Weapon::Bottle),
        18 => Some(playsrc_tf2::Weapon::GrenadeLauncher),
        ...
        90 => Some(playsrc_tf2::Weapon::DirectHit),
        91 => Some(playsrc_tf2::Weapon::BlackBox),
        92 => Some(playsrc_tf2::Weapon::LibertyLauncher),
        93 => Some(playsrc_tf2::Weapon::RocketJumper),
        94 => Some(playsrc_tf2::Weapon::AirStrike),
        95 => Some(playsrc_tf2::Weapon::FlareGun),
        96 => Some(playsrc_tf2::Weapon::Detonator),
        97 => Some(playsrc_tf2::Weapon::ScorchShot),
        98 => Some(playsrc_tf2::Weapon::Manmelter),
        _ => return None,
    };
