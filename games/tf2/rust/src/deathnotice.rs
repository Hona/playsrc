...
pub fn weapon_name(weapon: Weapon, class: PlayerClass) -> &'static str {
    match weapon {
        ...
        Weapon::DirectHit => "rocketlauncher_directhit",
        Weapon::BlackBox => "blackbox",
        Weapon::LibertyLauncher => "liberty_launcher",
        Weapon::RocketJumper => "tf_projectile_rocket",
        Weapon::AirStrike => "airstrike",
        Weapon::FlareGun => "flaregun",
        Weapon::Detonator => "detonator",
        Weapon::ScorchShot => "scorch_shot",
        Weapon::Manmelter => "manmelter",
