...
- Publish rockets through point-trace requests and stickies through IVP body requests, accepting only validated external results. Retain owner, launcher, team, charge/arm/stuck state, normalized orientation/contact data, ordered presentation-neutral events, and one exact radius-damage request without substituting a projectile solver.
