...
describe("configured TF2 startup media", () => {
  ...
  test("rejects malformed and changed configured media", () => {
    ...
    expect(validateTf2StartupDescriptor({ ...TF2_CONFIGURED_STARTUP, source: { ...TF2_CONFIGURED_STARTUP.source, sha256: "0".repeat(64) } })).toEqual({ ok: false, code: "ChangedConfiguredMedia", subject: "build-24245096" })
  })
})
