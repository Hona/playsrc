...
function copyKillfeed(value: Tf2HudKillfeedNotice): Tf2HudKillfeedNotice {
  return Object.freeze({
    ...
    weaponIcon: copyAvailability(value.weaponIcon, (item) => text(item, "killfeed weapon icon", 255), "killfeed weapon icon"),
    ...
    damageBits: integer(value.damageBits, "killfeed damage bits"),
