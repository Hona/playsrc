...
const ROOTS: &[(&str, &str, bool)] = &[
    ...
    ("hud", "resource/ui/hudobjectivekothtimepanel.res", true),
    ...
    ("hud", "resource/ui/huditemeffectmeter_demoman.res", true),
    ("hud", "resource/ui/huditemeffectmeter_engineer.res", true),
    ("hud", "resource/ui/huditemeffectmeter_sniper.res", true),
