...
const PROFILES = Object.freeze({
  ...
  "koth-sustained-sawmill": { config: "playwright.profile.config.ts", target: "koth_sawmill", environment: { PROFILE_SCENARIOS: "upward-training-bots", PROFILE_KOTH_SUSTAINED: "1", PROFILE_MAP_TARGET: "koth_sawmill", PROFILE_SAMPLE_SECONDS: "5" }, minimumRemainingMilliseconds: 150_000 },
  "koth-sustained-lakeside": { config: "playwright.profile.config.ts", target: "koth_lakeside_final", environment: { PROFILE_SCENARIOS: "upward-training-bots", PROFILE_KOTH_SUSTAINED: "1", PROFILE_MAP_TARGET: "koth_lakeside_final", PROFILE_SAMPLE_SECONDS: "5" }, minimumRemainingMilliseconds: 150_000 },
