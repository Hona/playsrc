...
const PROFILES = Object.freeze({
  ...
  "sustained-harvest": { config: "playwright.profile.config.ts", target: "koth_harvest_final", environment: { PROFILE_SCENARIOS: "sustained-koth", PROFILE_MAP_TARGET: "koth_harvest_final", PLAYSRC_PROFILE_VIEWPORT_WIDTH: "1689", PLAYSRC_PROFILE_VIEWPORT_HEIGHT: "1277", PLAYSRC_PROFILE_DEVICE_SCALE_FACTOR: "1" }, minimumRemainingMilliseconds: 165_000 },
  "sustained-viaduct": { config: "playwright.profile.config.ts", target: "koth_viaduct", environment: { PROFILE_SCENARIOS: "sustained-koth", PROFILE_MAP_TARGET: "koth_viaduct", PLAYSRC_PROFILE_VIEWPORT_WIDTH: "1689", PLAYSRC_PROFILE_VIEWPORT_HEIGHT: "1277", PLAYSRC_PROFILE_DEVICE_SCALE_FACTOR: "1" }, minimumRemainingMilliseconds: 165_000 },
