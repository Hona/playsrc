...
const PROFILES = Object.freeze({
  ...
  "sustained-harvest-setup": { config: "playwright.profile.config.ts", target: "koth_harvest_final", environment: { PROFILE_SCENARIOS: "sustained-koth", PROFILE_KOTH_SETUP_ONLY: "1", PROFILE_MAP_TARGET: "koth_harvest_final", PLAYSRC_PROFILE_BROWSER_CHANNEL: "msedge", PLAYSRC_PROFILE_VIEWPORT_WIDTH: "1689", PLAYSRC_PROFILE_VIEWPORT_HEIGHT: "1277", PLAYSRC_PROFILE_DEVICE_SCALE_FACTOR: "1" }, minimumRemainingMilliseconds: 60_000 },
  ...
  "demoman-physics": {config:"playwright.profile.config.ts",target:"jump_beef",environment:{PROFILE_SCENARIOS:"demoman-physics",PROFILE_SAMPLE_SECONDS:"5"},minimumRemainingMilliseconds:150_000},
  "demoman-prop-contact": {config:"playwright.profile.config.ts",target:"jump_beef",environment:{PROFILE_SCENARIOS:"demoman-physics",PROFILE_DEMOMAN_PROP:"1",PROFILE_SAMPLE_SECONDS:"5"},minimumRemainingMilliseconds:150_000},
  "demoman-grenade": {config:"playwright.profile.config.ts",target:"jump_beef",environment:{PROFILE_SCENARIOS:"demoman-grenade",PROFILE_SAMPLE_SECONDS:"5"},minimumRemainingMilliseconds:150_000},
  ...
  "particle-alias-pixels": { config: "playwright.map-memory-profile.config.ts", target: "pl_upward", environment: { PROFILE_MEMORY_TARGET: "pl_upward", PROFILE_MEMORY_LABEL: "particle-alias-pixels", PROFILE_MEMORY_LIGHTMAP_AUDIT: "1", PROFILE_MEMORY_INPUT_DIAGNOSTIC: "1", PROFILE_MEMORY_LOCAL_PERMISSION: "1", PROFILE_MEMORY_ALIAS_PIXELS: "1", PROFILE_SAMPLE_SECONDS: "5" }, minimumRemainingMilliseconds: 100_000 },
  "particle-alias-reference": { config: "playwright.map-memory-profile.config.ts", target: "pl_upward", environment: { PROFILE_MEMORY_SEQUENCE: "pl_upward,pl_upward", PROFILE_MEMORY_LABEL: "particle-alias-reference", PROFILE_MEMORY_LIGHTMAP_AUDIT: "1", PROFILE_MEMORY_INPUT_DIAGNOSTIC: "1", PROFILE_MEMORY_INPUT: "1", PROFILE_MEMORY_LOCAL_PERMISSION: "1", PROFILE_MEMORY_ALIAS_REFERENCE: "1", PROFILE_SAMPLE_SECONDS: "10" }, minimumRemainingMilliseconds: 100_000 },
  "particle-alias-candidate": { config: "playwright.map-memory-profile.config.ts", target: "pl_upward", environment: { PROFILE_MEMORY_SEQUENCE: "pl_upward,pl_upward", PROFILE_MEMORY_LABEL: "particle-alias-candidate", PROFILE_MEMORY_LIGHTMAP_AUDIT: "1", PROFILE_MEMORY_INPUT_DIAGNOSTIC: "1", PROFILE_MEMORY_INPUT: "1", PROFILE_MEMORY_LOCAL_PERMISSION: "1", PROFILE_SAMPLE_SECONDS: "10" }, minimumRemainingMilliseconds: 100_000 },
  "particle-alias-combat-reference": { config: "playwright.map-memory-profile.config.ts", target: "pl_upward", environment: { PROFILE_MEMORY_TARGET: "pl_upward", PROFILE_MEMORY_LABEL: "particle-alias-combat-reference", PROFILE_MEMORY_LIGHTMAP_AUDIT: "1", PROFILE_MEMORY_INPUT_DIAGNOSTIC: "1", PROFILE_MEMORY_INPUT: "1", PROFILE_MEMORY_LOCAL_PERMISSION: "1", PROFILE_MEMORY_ALIAS_REFERENCE: "1", PROFILE_MEMORY_ALIAS_COMBAT: "1", PROFILE_SAMPLE_SECONDS: "5" }, minimumRemainingMilliseconds: 100_000 },
  "particle-alias-combat-candidate": { config: "playwright.map-memory-profile.config.ts", target: "pl_upward", environment: { PROFILE_MEMORY_TARGET: "pl_upward", PROFILE_MEMORY_LABEL: "particle-alias-combat-candidate", PROFILE_MEMORY_LIGHTMAP_AUDIT: "1", PROFILE_MEMORY_INPUT_DIAGNOSTIC: "1", PROFILE_MEMORY_INPUT: "1", PROFILE_MEMORY_LOCAL_PERMISSION: "1", PROFILE_MEMORY_ALIAS_COMBAT: "1", PROFILE_SAMPLE_SECONDS: "5" }, minimumRemainingMilliseconds: 100_000 },
  "owned-browser-ui-memory": { config: "playwright.map-memory-profile.config.ts", target: "pl_upward", environment: { PROFILE_MEMORY_TARGET: "pl_upward", PROFILE_MEMORY_LABEL: "owned-browser-ui-memory", PROFILE_MEMORY_LIGHTMAP_AUDIT: "1", PROFILE_MEMORY_INPUT_DIAGNOSTIC: "1", PROFILE_MEMORY_OWNED_UI_DIAGNOSTIC: "1", PROFILE_SAMPLE_SECONDS: "5" }, minimumRemainingMilliseconds: 45_000 },
  "owned-browser-ui-permission": { config: "playwright.map-memory-profile.config.ts", target: "pl_upward", environment: { PROFILE_MEMORY_TARGET: "pl_upward", PROFILE_MEMORY_LABEL: "owned-browser-ui-permission", PROFILE_MEMORY_LIGHTMAP_AUDIT: "1", PROFILE_MEMORY_INPUT_DIAGNOSTIC: "1", PROFILE_MEMORY_OWNED_UI_DIAGNOSTIC: "1", PROFILE_MEMORY_LOCAL_PERMISSION: "1", PROFILE_SAMPLE_SECONDS: "5" }, minimumRemainingMilliseconds: 45_000 },
  ...
  "class-input-correctness": { config: "playwright.profile.config.ts", target: "pl_upward", environment: { PROFILE_SCENARIOS: "upward-training-bots", PROFILE_UPWARD_CLASS_SWITCH: "1", PROFILE_CLASS_INPUT_CORRECTNESS: "1", PLAYSRC_PROFILE_VIEWPORT_WIDTH: "1689", PLAYSRC_PROFILE_VIEWPORT_HEIGHT: "1277", PLAYSRC_PROFILE_DEVICE_SCALE_FACTOR: "1" } },
  ...
  "equipment-navigation": { config: "playwright.equipment-navigation.config.ts", target: "pl_upward", arguments: ["--grep", "equipment trusted input"] },
  "equipment-navigation-cpu": { config: "playwright.equipment-navigation.config.ts", target: "pl_upward", arguments: ["--grep", "equipment trusted input"], environment: { PLAYSRC_EQUIPMENT_CPU: "1" } },
  "equipment-navigation-transactions": { config: "playwright.equipment-navigation.config.ts", target: "pl_upward", arguments: ["--grep", "equipment pending"] },
