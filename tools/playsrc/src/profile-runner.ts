...
const PROFILES = Object.freeze({
  ...
  "lightmap-replacement": { config: "playwright.map-memory-profile.config.ts", target: "pl_upward", environment: { PROFILE_MEMORY_SEQUENCE: "pl_upward,pl_upward", PROFILE_MEMORY_LABEL: "lightmap-replacement", PROFILE_MEMORY_LIGHTMAP_AUDIT: "1", PROFILE_SAMPLE_SECONDS: "10" }, minimumRemainingMilliseconds: 100_000 },
