...
const PROFILES = Object.freeze({
  ...
  "map-admission": { config: "playwright.profile.config.ts", target: "cp_badlands", environment: { PROFILE_SCENARIOS: "map-admission" }, minimumRemainingMilliseconds: environment => environment.PROFILE_MAP_TARGET === "cp_well" && !environment.PROFILE_MAP_PIPELINE_PROBE && !environment.PROFILE_MAP_LEGACY_SPRITE && !environment.PROFILE_MAP_LEGACY_GLOW && !environment.PROFILE_SPAWN_ONLY ? 130_000 : DEFAULT_BROWSER_MINIMUM_MILLISECONDS },
