...
// Harmless background workload for real native ownership/teardown tests. No browser, game,
...
if (process.platform === "win32") {
  ...
  if (!ownership) throw new Error("Diagnostic workload has no native job ownership")
