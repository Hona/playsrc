...
mod dct_tests {
    #[test]
    fn dct_accumulation_matches_public_minimp3_sse_for_synthetic_blocks() {
        // minimp3 ea99364f61c14656440e8d77e9c233ccf3124633,
        // mp3d_DCT_II, SSE2, without floating-point contraction.
        for (n, expected) in [(12, 0xc1674235caf7767b_u64), (18, 0xb95e14df26286864)] {
            ...
            for sample in &mut samples {
                ...
                seed ^= seed >> 17;
                seed ^= seed << 5;
                *sample = ((seed & 65535) as i32 - 32768) as f32 / 512.0;
            }
            unsafe { super::mp3d_DCT_II(samples.as_mut_ptr(), n); }
            let hash = samples[..576].iter().fold(0xcbf29ce484222325_u64, |hash, value| {
