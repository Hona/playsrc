...
The entity graph contains 39 ordered `infodecal` records. Exact receiver evidence classifies 34 projected, four ineligible, and one missing material, producing 62 bounded fragments and 248 vertices. The ordered stream of source identity, classification, model/face identity, position/UV binary32 bits, and triangle indexes has SHA-256 `80420c17805c47b733fa473566fc19df81cb8ed80a416992d489e6517f608811`. Standard overlay and water-overlay lumps are empty. Empty compiled mark lumps are intentionally inert; an unknown nonempty version or malformed whole record is not.
