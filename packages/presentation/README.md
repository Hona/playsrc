...
| [`vgui/`](vgui/) | Source panel trees, controls, layouts, schemes, localization binding, HUD animations, developer-console presentation, focus, input, proportional scaling, and direct DOM/CSS presentation. |
