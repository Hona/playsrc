...
| Metadata | Value |
|---|---|
| Authority identity | Valve Source SDK 2013 `Panel`, `EditablePanel`, `BuildGroup`, and generic-control resource consumers; configured TF2 public build `24207079`, patch `10822003`, `.res` identities |
