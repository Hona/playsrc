...
| Metadata | Value |
|---|---|
| Authority identity | Valve Source SDK 2013 `AnimationController`, `PanelAnimationVar`, and panel property-converter contracts; configured TF2 public build `24245096`, patch `10828683`, HUD-animation manifest and resolved script composition |
