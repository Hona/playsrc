...
| Metadata | Value |
|---|---|
| Authority identity | Valve Source SDK 2013 `IScheme`, `ISurface`, `IBorder`, `IImage`, and generic-control scheme consumers; configured TF2 build `10822003` scheme identities |
