...
describe("generic Source VGUI runtime", () => {
  ...
  test("CEx border selection replaces rounded Button backgrounds and clears prior image borders", () => {
    ...
    expect(element.style.borderImageWidth).toBe("2px 2px")
    operation(runtime, { kind: "set-viewport", viewport: { width: 1280, height: 720, devicePixelRatio: 1.25 } })
    expect(element.style.borderImageWidth).toBe("3px 3px")
