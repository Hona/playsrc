...
- Consume PENV v2 decoded sky/cubemap inputs and authored Water texture chains, current controller/WaterLOD state, collision-selected mark receivers, and PVIS v2 above/below/reflection/refraction/main/intersection plans. Rendering executes Water targets, clips, fog/material state, animated normal frames, view-qualified surfaces, and state restoration; unresolved 2D-sky/cubemap shader execution remains explicit and Water auxiliary views fail rather than substitute black sky or a default cubemap.
