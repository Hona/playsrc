...
const output = path.join(config.sourceCacheDir, "evidence/tf2-browser-performance/dynamic-model-graphs")
...
try {
  ...
  const report = { headed: true, results, errors, milliseconds: Date.now() - started }
