...
for (const dpr of [1, 1.25, 1.5, 2]) test(`HUD frame-target viewport uses physical pixels at DPR ${dpr} and restores ownership`, () => {
  ...
  const presentation = sourceModelPanelPresentation({ model: "models/player/soldier.mdl", horizontalFov4By3: 25, origin: [110, 0, -56], bounds: { x: 12, y: 600, width: 100, height: 100 }, displayWidth: 1280 * dpr, displayHeight: 720 * dpr, devicePixelRatio: dpr })
