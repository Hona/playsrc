...
| Reproduce the content-build-specific TF2, CS:S, and legacy Source 1 CS:GO provider order from exact configured manifests and archive indexes without hardcoded game mounts. | The TF2 source-bundle operation pins build `24207079`, verifies configured `gameinfo.txt` SHA-256 `a85196fdeebeb4e2bae9d412862794d18a4970d118ea0a0d84817c44b8c982da` plus its `hl2` mount, and resolves active BSP PAK → `tf2_misc` → `tf2_textures` → `hl2_misc` → `hl2_textures`. Full gameinfo wildcard/path-ID expansion, other TF2 resource families, CS:S, legacy CS:GO, and generated provider inventories remain absent. | Exact `jump_beef` resolution produces 34 lowercase raw dependency entries after every selected provider read validates VPK CRC. Full generated provider-plan comparison remains absent. | Partial |
