...
export default defineConfig({
  ...
  testMatch: process.env.PROFILE_CTF_OBJECTIVES === "1"
  ...
  webServer: {
    command: `bun tools/playsrc/src/cli.ts dev ${process.env.PROFILE_CTF_OBJECTIVES === "1" ? "ctf_2fort" : process.env.PROFILE_MATERIAL_ANIMATION === "1" ? "pl_upward" : "jump_beef"}`,
