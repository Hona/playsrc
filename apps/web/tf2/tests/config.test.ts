...
const object = (kind: "source-object" | "derived-object" | "source-root", value: string, mediaType = "application/octet-stream") => ({ kind, mediaType, byteLength: "1", sha256: value.repeat(64) })
const valid = Object.freeze({
  ...
  catalog: object("catalog", "d", "application/vnd.playsrc.asset-catalog+json"),
