...
- Present the configured Main Menu before gameplay initialization; drive Console map loading, pause/resume/disconnect, TF2 HUD resources, and persistent Options through the game-owned GameUI/HUD adapters and generic VGUI runtime.
