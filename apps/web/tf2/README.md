...
- Accept exact configured `jump_beef` and `pl_upward` product identities; label/reload only the active target, preserve Jump and noclip authority, and attach no Payload meaning to parsed stock-map entities.
