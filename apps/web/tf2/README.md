...
- Consume PSSN v8 random/audio/Collision/pusher/Entity/locker facts, 123 brush descriptors, collision-selected moving marks, PMRQ v5/PMPO v4 hand-plus-item/ammunition frames, PSMP v3 facing, Particle v3 materials/sheets/trails, exact PMST v2 state for all 12 selected Particle materials, typed alpha discard, complete Water view plans, Source Audio, and configured macOS SourceScheme fonts. IVP remains explicit: sticky fire is rejected before spawn. Native glyph-raster and aligned target captures remain blockers.
