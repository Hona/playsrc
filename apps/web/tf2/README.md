...
- Consume Material/VTF static state and alpha marks, exact PSMP v2 occurrence matrices/poses/tangents/attachments/events, PSSN v4 Movement facts and smooth view offsets, textured Particle sheets/trails, and Source Audio definitions/neutral voices. The default world view uses TF2's 75-degree horizontal-4:3 projection, near Z 7, and map-extent far Z. The blocker ledger retains missing authored texture mips, complete model shaders/lighting, stock hand/`c_model` viewmodel composition, sky/cubemap subresources, Water views, fog state, and TF2 random sound samples without claiming diagnostic pixels as parity.
