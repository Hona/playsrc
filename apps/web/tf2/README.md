...
- Consume Material/VTF static state and alpha marks, PSMP v2 model matrices/poses/tangents/attachments/events, PMTK Movement facts and smooth view offsets, textured Particle sheets/trails, and Source Audio definitions/neutral voices. Viewmodels use their own FOV/depth pass; unavailable TF2 random sound samples remain blockers.
