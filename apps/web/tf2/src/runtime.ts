...
export class Tf2Application {
  ...
  #resetHudIntegration(): void {
    ...
    this.#hudIntegration = initializeTf2HudIntegration({
      ...
      random: this.#presentationRandom,
      onCommand: (command) => {
       if (command.kind === "select-weapon" && command.weapon >= 1 && command.weapon <= 16) this.#selectWeapon = command.weapon as Tf2Weapon
  ...
  #activateBoundAction(identity: string, action: string): void {
   ...
   } else if (action === "slot1") this.#selectWeapon = this.#snapshot?.class === 1 ? 4 : this.#snapshot?.class === 2 ? 12 : this.#snapshot?.class === 6 ? 9 : this.#snapshot?.class === 7 ? 15 : 1
    else if (action === "slot2") this.#selectWeapon = this.#snapshot?.class === 1 ? 5 : this.#snapshot?.class === 2 ? 13 : this.#snapshot?.class === 3 ? 7 : this.#snapshot?.class === 6 ? 10 : this.#snapshot?.class === 7 ? 7 : 3
    else if (action === "slot3") this.#selectWeapon = this.#snapshot?.class === 1 ? 6 : this.#snapshot?.class === 2 ? 14 : this.#snapshot?.class === 3 ? 8 : this.#snapshot?.class === 6 ? 11 : this.#snapshot?.class === 7 ? 16 : undefined
