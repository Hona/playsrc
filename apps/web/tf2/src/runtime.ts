  ...
  #resetHudIntegration(): void {
    ...
    this.#hudIntegration = initializeTf2HudIntegration({
      ...
      onCommand: (command) => {
        ...
        if (command.kind === "select-weapon" && (command.weapon >= 1 && command.weapon <= 18 || command.weapon >= 50 && command.weapon <= 54 || command.weapon >= 40 && command.weapon <= 42) && command.weapon !== 54) this.#selectWeapon = command.weapon as Tf2Weapon
